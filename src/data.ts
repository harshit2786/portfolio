...
export const PORTFOLIO = {
  ...
  techStack: {
    frontend: [
      ...
      { name: "Redux / Recoil", color: "#764abc" },
    ],
    backend: [
      { name: "Node.js",    color: "#68a063" },
      { name: "Express",    color: "#888888" },
      { name: "FastAPI",    color: "#009688" },
      { name: "Rust (Axum)",color: "#dea584" },
      { name: "Go",         color: "#00add8" },
      { name: "Strapi",     color: "#8c4bff" },
    ],
    database: [
...
export const TRANSLATIONS = {
  en: {
    ...
    footer: {
      copy: "HARSHIT KUMAR SINGH // デジタル侍",
      made: "FORGED WITH",
      in: "IN TOKYO TIME",
    },
  },
  jp: {
    ...
    footer: {
      copy: "ハーシット・クマール・シン // Digital Samurai",
      made: "で作られた",
      in: "東京時間",
    },
  },
